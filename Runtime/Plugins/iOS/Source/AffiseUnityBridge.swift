@_cdecl("_c_register_callback")
public func registerCallback(_ handler: @convention(c) @escaping (UnsafePointer<CChar>?, UnsafePointer<CChar>?) -> Void) {
