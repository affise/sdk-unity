    ...
    public class PostBackModelToJsonStringConverter : IConverter<List<PostBackModel>, string>
    {
        ...
        private JSONObject MakeParameters(PostBackModel obj)
        {
            ...
            return new JSONObject
            {
                ...
                [Parameters.REFERRER_INSTALL_VERSION] = obj.ReferrerInstallVersion,
                [Parameters.REFERRER_CLICK_TIME] = obj.ReferrerClickTimestamp,
                [Parameters.REFERRER_CLICK_TIME_SERVER] = obj.ReferrerClickTimestampServer,
                [Parameters.REFERRER_GOOGLE_PLAY_INSTANT] = obj.ReferrerGooglePlayInstant,
